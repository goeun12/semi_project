...
<style>
	...
	#header{min-width: 1250px; background: #F24822; height: 60px; width: 100%; position: fixed; top: 0px; left: 0px; right: 0px;}
 	...
 	<%--로고 이미지--%>
	#logoImg{width:35px; height: 38px; margin-left: 20px; margin-right: 20px; float: left;}
 	<%--레시피~공지사항 감싸는 div--%>
	#header_menu{margin-left:10px; float: left; margin-top: 15px;}
	<%--로고~공지사항까지 각각의 a태그 class="button"--%>
 	.button{color: white; text-decoration: none; font-size: 18px; margin-right: 20px;}
	.button:hover{font-weight: 600;}
	<%--로고~공지사항 버튼의 a태그들--%>
	.button a{color: black; text-decoration: none;}
	
	<%--로그인 o, x 전부 감싸는--%>
	#header_user{margin-right: 25px; float: right; margin-top: 15px;}   <%--학원 컴퓨터로는 #header_user{margin-right: 20px; float: right; margin-top: 14px;}--%>
...
<body>
	...
	<header id="header">
		<div id="header_menu" class="header_common">
			<a href="#" id="logoImg_A"><img src="resources/image/logo.png" id="logoImg" alt="로고"></a>
